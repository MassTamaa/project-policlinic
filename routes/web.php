...
Route::get('surat-rujukan', [SuratRujukanController::class, 'index'])->name('surat-rujukan.create');
Route::post('surat-rujukan/print', [SuratRujukanController::class, 'print'])->name('surat-rujukan.print');
